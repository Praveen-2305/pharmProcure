...
* **Property Graphs (NetworkX):** Essential for non-Euclidean legal hierarchies. A vector store cannot traverse relationships like:  
  $$\text{Drugs \& Cosmetics Act 1940} \longrightarrow \text{Schedule M} \longrightarrow \text{Form 28D License} \longrightarrow \text{Vendor Organization}$$
...
* **Our Solution:** The Fusion Engine (`app/rag/fusion.py`):
  1. Normalizes retriever scores to $[0, 1]$.
