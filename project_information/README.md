...
| [**`04_DATABASE_ARCHITECTURE_AND_BUILD_SYSTEM.md`**](04_DATABASE_ARCHITECTURE_AND_BUILD_SYSTEM.md) | The 5 database subsystems under `backend/database/` (Relational SQLite, Vector Qdrant, Graph NetworkX, Pricing DPCO, Contracts SLA) and the master `build_all.py` rebuild engine. |
