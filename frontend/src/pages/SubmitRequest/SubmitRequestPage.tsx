  ...
  return (
    <div className="max-w-4xl mx-auto p-6 md:p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
        <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800/80 text-left">
          <div className="text-xs font-mono font-semibold text-teal-400 flex items-center gap-1.5 mb-1.5">
